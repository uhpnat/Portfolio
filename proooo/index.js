...
const urlAuthor = "http://localhost:8000/v1/author/id/" + dataId;
const urlTheme = "http://localhost:8000/v1/theme/";
  ...
  const formData = new FormData();
        ...
        if (imageInput.files.length > 0) {
          ...
          fetch("http://localhost:8000/uploads", {
            ...
            .then((response) => {
              var renderImage = 'http://localhost:8000/uploads/'+response
              const dataToSend = {
                image : 'http://localhost:8000/uploads/'+response
              };
        ...
        if (imageInput.files.length > 0) {
          ...
          fetch("http://localhost:8000/uploads", {
            ...
            .then((response) => {
              var renderImage = 'http://localhost:8000/uploads/'+response
              const dataToSend = {
                background : 'http://localhost:8000/uploads/'+response
              };
              const requestOptions = {
                method: 'PUT',
                headers: {
