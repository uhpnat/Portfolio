...
// console.log(link);
// const urlAuthor = "http://localhost:8000/v1/author/" + link;
...
const link = queryString.get("link");
console.log(link);
const urlAuthor = "http://localhost:8000/v1/author/link/" + link;
console.log(urlAuthor);
showLoadingSpinner();
...
fetch(urlAuthor)
  ...
  function checkNextPage() {
    var linkProduct = 'http://localhost:8000/v1/author/product/';
